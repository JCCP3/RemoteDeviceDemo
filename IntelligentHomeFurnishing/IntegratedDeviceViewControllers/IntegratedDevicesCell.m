...
-(void)loadIntegratedDevicesCell:(SwitchInfo *)switchInfo withIndexPath:(NSIndexPath *)indexPath{
    ...
    if([switchInfo.switchAtCenterControllerStatus intValue] == 0)
    {
        ...
        _integratedSwitchNameLabel.textColor = [Utility colorWithHexString:@"#666666"];
        [_offBtn setTitleColor:[Utility colorWithHexString:@"#666666"]forState:UIControlStateNormal];
        [_onBtn setTitleColor:[Utility colorWithHexString:@"#666666"] forState:UIControlStateNormal];
        ...
        //开关可用
        _integratedSwitchNameLabel.textColor = [UIColor blackColor];
        [_offBtn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        [_onBtn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
